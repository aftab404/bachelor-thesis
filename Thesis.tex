...
% mandatory elements
\title{AI Agent as a First-Class Collaborator in the Optimization Platform}
\author{Aftab Khan}
...
\include{Content/Chapter_Introduction.tex}
% \include{Content/Chapter_Foundations.tex}
\include{Content/Chapter_RelatedWork}
\include{Content/Chapter_Concept.tex}
\include{Content/Chapter_Implementation}
\include{Content/Chapter_Evaluation}
\include{Content/Chapter_Conclusion}
