...
\begin{itemize}
    \item \textbf{4 Easy Problems:} Standard formulations (e.g., simple Knapsack, Diet Problem) requiring fewer variables and constraints. Specifically problem IDs 17, 1, 3, 4 From NLP4LP.
    \item \textbf{6 Hard Problems:} Complex formulations (e.g., Facility Location, Multi-commodity Flow) requiring advanced structural adjustments and multiple interacting constraints. Specifically problem IDs 301, 302, 303, 304, 305, 306 From NLP4LP.
\end{itemize}
